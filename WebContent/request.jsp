...
<body>
<%
String rr=request.getParameter("rr");  //rr=registration request
...
try{
    ...
    ResultSet rs=st.executeQuery("select * from registration where user='college' and status='pending'");
%>
    ...
    %>
        ...
        <table align="center" class="table table-borderless table-sm border">
			...
			<td>              
                ...
                <li><button name="rr">active</button></li><br>
                </form>
			</td>
            </tr>
        </table>
